  ...
  if (process.env.NODE_ENV !== "production") {
    useEffect(() => {
      if (
        ...
        console.error(
          `Insurance: A component is changing the defaultValue state of an uncontrolled ${componentName} after being initialized.` +
    ...
    useEffect(() => {
      if (isControlled !== (controlledValue !== undefined)) {
        console.error(
          [
            `Insurance: A component is changing the ${
              isControlled ? "" : "un"
